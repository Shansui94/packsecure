...
dns.resolve4('aws-0-ap-southeast-1.pooler.supabase.com', async (err, addresses) => {
    if (err || !addresses || addresses.length === 0) {
        console.error('DNS resolve4 failed:', err);
        return;
    }
    const ip = addresses[0];
    console.log("Resolved Pooler IPv4 IP:", ip);
    ...
    try {
        ...
        console.log("✅ Connected successfully via Pooler IPv4!");
