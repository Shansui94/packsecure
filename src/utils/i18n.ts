...
export const CORE_TERMS: {
    ...
    { en: 'Draft', 'zh-CN': '草稿', 'zh-TW': '草稿', ms: 'Draf', my: 'မူကြမ်း', hi: 'प्रारूप', bn: 'খসড়া' },
...
const resources = {
    'zh-CN': { translation: { ...buildDictionaryForLanguage('zh-CN'), ...zhCNJson } },
    'en': { translation: { ...buildDictionaryForLanguage('en'), ...enJson } },
    'ms': { translation: { ...buildDictionaryForLanguage('ms'), ...msJson } },
    'my': { translation: { ...buildDictionaryForLanguage('my'), ...myJson } },
    'zh-TW': { translation: { ...buildDictionaryForLanguage('zh-TW'), ...zhTWJson } },
    'hi': { translation: { ...buildDictionaryForLanguage('hi'), ...hiJson } },
    'bn': { translation: { ...buildDictionaryForLanguage('bn'), ...bnJson } }
};
