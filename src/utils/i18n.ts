...
export const CORE_TERMS: {
    ...
    // 导航与菜单治理 Navigation & Menu Governance
    { en: 'Stock Audit & Reports', 'zh-CN': '库存盘点与审计', 'zh-TW': '庫存盤點與審計', ms: 'Audit & Laporan Stok', my: 'ပစ္စည်းစာရင်းစစ်နှင့် အစီရင်ခံစာများ', hi: 'स्टॉक ऑडिट और रिपोर्ट', bn: 'স্টক অডিট এবং রিপোর্ট' },
    { en: 'Dev & Task Log', 'zh-CN': '系统升级与工作日志', 'zh-TW': '系統升級與工作日誌', ms: 'Log Naik Taraf & Tugas', my: 'စနစ်အဆင့်မြှင့်တင်မှုနှင့် လုပ်ငန်းမှတ်တမ်း', hi: 'सिस्टम अपग्रेड और कार्य लॉग', bn: 'সিস্টেম আপগ্রেড এবং টাস্ক লগ' },
    { en: 'System Docs', 'zh-CN': '系统文档中心', 'zh-TW': '系統文檔中心', ms: 'Pusat Dokumen Sistem', my: 'စနစ်စာရွက်စာတမ်းဗဟို', hi: 'सिस्टम दस्तावेज़ केंद्र', bn: 'সিস্টেম ডকুমেন্ট কেন্দ্র' },
    { en: 'Machine Report History', 'zh-CN': '机台历史生产报告', 'zh-TW': '機台歷史生產報告', ms: 'Sejarah Laporan Mesin', my: 'စက်ထုတ်လုပ်မှု အစီရင်ခံစာဟောင်းများ', hi: 'मशीन रिपोर्ट इतिहास', bn: 'मेशिन रिपोर्ट इतिहास' },
    { en: 'More Collapsed Features', 'zh-CN': '更多已收起功能', 'zh-TW': '更多已收起功能', ms: 'Lebih Banyak Ciri Ditutup', my: 'အခြားခေါက်ထားသော လုပ်ဆောင်ချက်များ', hi: 'अधिक संकुचित सुविधाएं', bn: 'আরও ভাঁজ করা বৈশিষ্ট্য' },
    { en: 'App Hub & Menu Manager', 'zh-CN': '全功能中心与菜单治理', 'zh-TW': '全功能中心與選單治理', ms: 'Hab Aplikasi & Pengurusan Menu', my: 'အက်ပ်ဗဟိုနှင့် မီနူးစီမံခန့်ခွဲမှု', hi: 'ऐप हब और मेनू प्रबंधन', bn: 'অ্যাপ হাব এবং মেনু পরিচালনা' },
    { en: 'Open App Hub & Menu Manager', 'zh-CN': '打开全功能中心与菜单管理', 'zh-TW': '打開全功能中心與選單管理', ms: 'Buka Hab Aplikasi & Pengurusan Menu', my: 'အက်ပ်ဗဟိုနှင့် မီနူးစီမံခန့်ခွဲမှုကို ဖွင့်ပါ', hi: 'ऐप हब और मेनू प्रबंधन खोलें', bn: 'অ্যাপ হাব এবং মেনু পরিচালনা খুলুন' },
    { en: 'Pinned in Sidebar', 'zh-CN': '常驻侧栏', 'zh-TW': '常駐側欄', ms: 'Dikekalkan di Bar Sisi', my: 'ဘေးဘားတွင် ပင်ထိုးထားသည်', hi: 'साइडबार में पिन किया गया', bn: 'সাইডবারে পিন করা' },
    { en: 'Collapsed', 'zh-CN': '已收起', 'zh-TW': '已收起', ms: 'Terkumpul', my: 'ခေါက်ထားသည်', hi: 'संकुचित', bn: 'সঙ্কুচিত' },
    { en: 'Collapsed / Secondary', 'zh-CN': '已收起/二级', 'zh-TW': '已收起/次級', ms: 'Terkumpul / Sekunder', my: 'ခေါက်ထားသည် / ဒုတိယအဆင့်', hi: 'संकुचित / द्वितीयक', bn: 'সঙ্কুচিত / মাধ্যমিক' },
    { en: 'Pin to Sidebar', 'zh-CN': '固定至侧栏常驻', 'zh-TW': '固定至側欄常駐', ms: 'Semat ke Bar Sisi', my: 'ဘေးဘားသို့ ပင်ထိုးပါ', hi: 'साइडबार में पिन करें', bn: 'সাইডবারে পিন করুন' },
    { en: 'Collapse to More', 'zh-CN': '移入收起功能', 'zh-TW': '移入收起功能', ms: 'Pindah ke Ciri Ditutup', my: 'ခေါက်ထားသော လုပ်ဆောင်ချက်သို့ ရွှေ့ပါ', hi: 'अधिक संकुचित में ले जाएं', bn: 'আরও বৈশিষ্ট্যে স্থানান্তর করুন' },
    { en: 'Show All Mode: ON', 'zh-CN': '全部平铺模式：开', 'zh-TW': '全部平鋪模式：開', ms: 'Mod Papar Semua: Hidup', my: 'အားလုံးပြသမှုစနစ်: ဖွင့်', hi: 'सभी दिखाएं मोड: चालू', bn: 'সমস্ত প্রদর্শন মোড: চালু' },
    { en: 'Smart Collapse: ON', 'zh-CN': '智能负熵收拢：开', 'zh-TW': '智能負熵收攏：開', ms: 'Runtuhan Pintar: Hidup', my: 'စမတ်ကျစ်လစ်မှုစနစ်: ဖွင့်', hi: 'स्मार्ट संक्षिप्त: चालू', bn: 'স্মার্ট সংক্ষিপ্তকরণ: চালু' },
    { en: 'Tile all functions in sidebar', 'zh-CN': '一键在侧栏平铺展示所有功能', 'zh-TW': '一鍵在側欄平鋪展示所有功能', ms: 'Papar semua fungsi di bar sisi', my: 'ဘေးဘားတွင် လုပ်ဆောင်ချက်အားလုံးကို ပြသပါ', hi: 'साइडबार में सभी कार्य दिखाएं', bn: 'সাইডবারে সমস্ত ফাংশন প্রদর্শন করুন' },
    { en: 'Reset to Default', 'zh-CN': '恢复推荐', 'zh-TW': '恢復推薦', ms: 'Pulih Cadangan', my: 'အကြံပြုချက်အတိုင်း ပြန်ထားပါ', hi: 'अनुशंसित पर रीसेट करें', bn: 'প্রস্তাবিত রিসেট করুন' },
    { en: 'Restore recommended layout', 'zh-CN': '恢复系统推荐的默认收起/常驻设置', 'zh-TW': '恢復系統推薦的默認收起/常駐設置', ms: 'Pulihkan tetapan cadangan sistem', my: 'စနစ်အကြံပြုထားသော ပုံသေသတ်မှတ်ချက်များသို့ ပြန်ထားပါ', hi: 'सिस्टम अनुशंसित सेटिंग्स पुनर्स्थापित करें', bn: 'সিস্টেম প্রস্তাবিত সেটিংস পুনরুদ্ধার করুন' },
    { en: 'All Groups', 'zh-CN': '全部组别', 'zh-TW': '全部組別', ms: 'Semua Kumpulan', my: 'အုပ်စုအားလုံး', hi: 'सभी समूह', bn: 'সমস্ত গ্রুপ' },
    { en: 'Launch', 'zh-CN': '立即进入', 'zh-TW': '立即進入', ms: 'Masuk Sekarang', my: 'ချက်ချင်းဝင်ပါ', hi: 'तुरंत जाएं', bn: 'এখনই প্রবেশ করুন' },
    { en: 'No matching features found', 'zh-CN': '未找到匹配的功能模块', 'zh-TW': '未找到匹配的功能模組', ms: 'Tiada modul fungsi yang sepadan', my: 'ကိုက်ညီသော လုပ်ဆောင်ချက်မရှိပါ', hi: 'कोई मेल खाता मॉड्यूल नहीं मिला', bn: 'কোনো মিল থাকা মডিউল পাওয়া যায়নি' },
    { en: 'Try clearing filters or changing search keywords', 'zh-CN': '请尝试清除筛选条件或更换搜索词', 'zh-TW': '請嘗試清除篩選條件或更換搜尋詞', ms: 'Sila kosongkan penapis atau ubah kata carian', my: 'စစ်ထုတ်မှုများကို ရှင်းပါ သို့မဟုတ် စကားလုံးပြောင်းရှာပါ', hi: 'कृपया फ़िल्टर हटाएं या खोज शब्द बदलें', bn: 'দয়া করে ফিল্টার সাফ করুন বা অনুসন্ধানের শব্দ পরিবর্তন করুন' },
    { en: 'Click to collapse: move to "More Collapsed Features"', 'zh-CN': '点击收起：移入“更多收起功能”', 'zh-TW': '點擊收起：移入“更多收起功能”', ms: 'Klik untuk kumpul: pindah ke ciri ditutup', my: 'ခေါက်ရန် နှိပ်ပါ: အခြားလုပ်ဆောင်ချက်သို့ ရွှေ့ပါ', hi: 'संकुचित करने के लिए क्लिक करें', bn: 'সঙ্কুচিত করতে ক্লিক করুন' },
    { en: 'Click to pin: keep visible in sidebar', 'zh-CN': '点击固定：常驻显示在侧边栏', 'zh-TW': '點擊固定：常駐顯示在側邊欄', ms: 'Klik untuk pin: kekal di bar sisi', my: 'ပင်ထိုးရန် နှိပ်ပါ: ဘေးဘားတွင် အမြဲပြသပါ', hi: 'पिन करने के लिए क्लिक करें', bn: 'পিন করতে ক্লিক করুন' },
    { en: 'No description available', 'zh-CN': '暂无业务描述', 'zh-TW': '暫無業務描述', ms: 'Tiada penerangan perniagaan', my: 'လုပ်ငန်းဖော်ပြချက်မရှိပါ', hi: 'कोई विवरण उपलब्ध नहीं है', bn: 'কোনো বিবরণ উপলব্ধ নেই' },
    { en: 'Current page', 'zh-CN': '当前所在页面', 'zh-TW': '當前所在頁面', ms: 'Halaman semasa', my: 'လက်ရှိစာမျက်နှာ', hi: 'वर्तमान पृष्ठ', bn: 'বর্তমান পৃষ্ঠা' },
    { en: 'Explore and customize your sidebar, navigate directly to any module.', 'zh-CN': '了解所有常驻与收起模块，随心定制您的侧边栏，支持一键直达处理任意业务。', 'zh-TW': '了解所有常駐與收起模組，隨心定制您的側邊欄，支持一鍵直達處理任意業務。', ms: 'Ketahui semua modul, sesuaikan bar sisi anda, dan akses sebarang fungsi dengan cepat.', my: 'မော်ဂျူးအားလုံးကို ကြည့်ရှုပြီး ဘေးဘားကို စိတ်ကြိုက်ပြင်ဆင်နိုင်ပါသည်။', hi: 'सभी मॉड्यूल देखें, साइडबार को अनुकूलित करें और किसी भी कार्य पर तुरंत जाएं।', bn: 'সমস্ত মডিউল অন্বেষণ করুন, আপনার সাইডবার কাস্টমাইজ করুন এবং যে কোনো কাজে সরাসরি যান।' },
    { en: 'Total features', 'zh-CN': '项功能', 'zh-TW': '項功能', ms: 'fungsi', my: 'လုပ်ဆောင်ချက်', hi: 'सुविधाएं', bn: 'ফাংশন' },
    { en: 'Search features, pinyin, English or business description...', 'zh-CN': '搜索功能名称、拼音、英文或业务描述...', 'zh-TW': '搜尋功能名稱、拼音、英文或業務描述...', ms: 'Cari modul, pinyin, bahasa Inggeris atau penerangan...', my: 'လုပ်ဆောင်ချက်အမည်၊ အင်္ဂလိပ် သို့မဟုတ် ဖော်ပြချက် ရှာဖွေပါ...', hi: 'सुविधा नाम, अंग्रेजी या विवरण खोजें...', bn: 'ফাংশনের নাম, ইংরেজি বা বিবরণ অনুসন্ধান করুন...' },
    { en: 'Tip: Collapsed modules can be expanded anytime from "More Collapsed Features" at sidebar bottom, or pinned here. Press ⌘K to search & jump anytime.', 'zh-CN': '提示：被收起的模块在侧栏底部「更多收起功能」中可随时展开，或在此弹窗中一键固定。快捷键 ⌘K 随时可全局搜索直达。', 'zh-TW': '提示：被收起的模組在側欄底部「更多收起功能」中可隨時展開，或在此彈窗中一鍵固定。快捷鍵 ⌘K 隨時可全局搜尋直達。', ms: 'Tip: Modul ditutup boleh dibuka di bar sisi bawah, atau dipin di sini. Pintasan ⌘K untuk carian pantas.', my: 'အကြံပြုချက်: ခေါက်ထားသော လုပ်ဆောင်ချက်များကို ဘေးဘားအောက်ခြေတွင် ဖွင့်နိုင်ပါသည် သို့မဟုတ် ဤနေရာတွင် ပင်ထိုးနိုင်ပါသည်။ ⌘K ဖြင့် အမြန်ရှာဖွေနိုင်ပါသည်။', hi: 'सुझाव: संकुचित मॉड्यूल साइडबार के नीचे से खोले जा सकते हैं। ⌘K से त्वरित खोज करें।', bn: 'পরামর্শ: ভাঁজ করা মডিউলগুলি সাইডবারের নিচ থেকে খোলা যেতে পারে। দ্রুত অনুসন্ধানের জন্য ⌘K চাপুন।' },
    { en: 'Currently showing: ', 'zh-CN': '当前显示：', 'zh-TW': '當前顯示：', ms: 'Sedang dipaparkan: ', my: 'လက်ရှိပြသနေသည်: ', hi: 'वर्तमान प्रदर्शन: ', bn: 'বর্তমানে প্রদর্শিত: ' },
    { en: 'All', 'zh-CN': '全部', 'zh-TW': '全部', ms: 'Semua', my: 'အားလုံး', hi: 'सभी', bn: 'সমস্ত' },
    { en: 'Stock Audit (Physical Count)', 'zh-CN': '实物盘点作业', 'zh-TW': '實物盤點作業', ms: 'Operasi Audit Stok Fizikal', my: 'လက်တွေ့ပစ္စည်းစာရင်းစစ်ဆေးခြင်း', hi: 'भौतिक स्टॉक गणना कार्य', bn: 'শারীরিক স্টক গণনা কাজ' },
    { en: 'Audit Variance Report', 'zh-CN': '盘点损益报告', 'zh-TW': '盤點損益報告', ms: 'Laporan Varians Audit Stok', my: 'စာရင်းစစ် ကွာဟချက်အစီရင်ခံစာ', hi: 'ऑडिट विचरण रिपोर्ट', bn: 'অডিট বৈষম্য রিপোর্ট' },
    { en: 'QR Labels', 'zh-CN': '二维码标签', 'zh-TW': '二維碼標籤', ms: 'Label Kod QR', my: 'QR ကုဒ် အညွှန်း', hi: 'क्यूआर लेबल', bn: 'কিউআর লেবেল' },
    { en: 'Print machine QR code labels', 'zh-CN': '打印机台二维码标签', 'zh-TW': '打印機台二維碼標籤', ms: 'Cetak label kod QR mesin', my: 'စက် QR ကုဒ်အညွှန်းများကို ပရင့်ထုတ်ပါ', hi: 'मशीन क्यूआर कोड लेबल प्रिंट करें', bn: 'মেশিন কিউআর কোড লেবেল প্রিন্ট করুন' },
    ...
    // 🛒 缠绕膜与车间多功能工位 (Stretch Film & Universal Machine Cockpit)
    { en: 'Stretch Film Trolley Output', 'zh-CN': '拉伸膜推车拍照算箱', 'zh-TW': '拉伸膜推車拍照算箱', ms: 'Kiraan Kotak Troli Stretch Film', my: 'စထရက်ဖလင် ထော်လာဂျီသေတ္တာအရေအတွက်', hi: 'स्ट्रेच फिल्म ट्रॉली आउटपुट', bn: 'স্ট্রেচ ফিল্ম ট্রলি আউটপুট' },
    { en: 'Trolley Output', 'zh-CN': '推车出箱报工', 'zh-TW': '推車出箱報工', ms: 'Keluaran Troli', my: 'ထော်လာဂျီထွက်ကုန်', hi: 'ट्रॉली उत्पादन', bn: 'ট্রলি আউটপুট' },
    { en: 'Shopfloor SOP: Usually 10 boxes/trolley (6 rolls/box). Snap blue trolley for instant output logging', 'zh-CN': '现场 SOP: 每车通常堆放 10 箱（每箱 6 卷），拍摄蓝色推车即可极速完成报工', 'zh-TW': '現場 SOP: 每車通常堆放 10 箱（每箱 6 卷），拍攝藍色推車即可極速完成報工', ms: 'SOP Tapak: Biasanya 10 kotak/troli (6 gulung/kotak). Tangkap foto troli biru untuk rekod segera', my: 'အလုပ်ရုံ SOP: ပုံမှန်အားဖြင့် ၁၀ သေတ္တာ/ထော်လာဂျီ (၆ လိပ်/သေတ္တာ)။ ချက်ချင်းမှတ်တမ်းတင်ရန် ထော်လာဂျီပြာ ဓာတ်ပုံရိုက်ပါ', hi: 'कार्यशाला एसओपी: सामान्यतः 10 डिब्बे/ट्रॉली (6 रोल/डिब्बा)। तत्काल रिकॉर्डिंग के लिए नीली ट्रॉली की तस्वीर लें', bn: 'ওয়ার্কশপ এসওপি: সাধারণত ১০ বাক্স/ট্রলি (৬ রোল/বাক্স)। তাত্ক্ষণিক রেকর্ডিংয়ের জন্য নীল ট্রলির ছবি তুলুন' },
    { en: 'Printer Link', 'zh-CN': '打标机直连', 'zh-TW': '打標機直連', ms: 'Pencetak Terpaut', my: 'ပရင်တာ ချိတ်ဆက်မှု', hi: 'प्रिंटर लिंक', bn: 'প্রিন্টার লিঙ্ক' },
    { en: 'Connect Printer', 'zh-CN': '连接打印机', 'zh-TW': '連接打印機', ms: 'Sambung Pencetak', my: 'ပရင်တာချိတ်ဆက်ပါ', hi: 'प्रिंटर कनेक्ट करें', bn: 'প্রিন্টার সংযুক্ত করুন' },
    { en: 'Select Product SKU Specification', 'zh-CN': '选择当前生产规格 (Product SKU)', 'zh-TW': '選擇當前生產規格 (Product SKU)', ms: 'Pilih Spesifikasi SKU Produk', my: 'ထုတ်ကုန် SKU သတ်မှတ်ချက်ကို ရွေးချယ်ပါ', hi: 'उत्पाद SKU विनिर्देश चुनें', bn: 'পণ্য SKU স্পেসিফিকেশন নির্বাচন করুন' },
    { en: 'Capture Finished Goods on Blue Trolley', 'zh-CN': '拍摄蓝色推车上的成品箱 (现场存证留痕)', 'zh-TW': '拍攝藍色推車上的成品箱 (現場存證留痕)', ms: 'Ambil Foto Kotak Siap atas Troli Biru (Bukti di Tapak)', my: 'ထော်လာဂျီပြာပေါ်ရှိ ကုန်ပစ္စည်းများ ဓာတ်ပုံရိုက်ပါ', hi: 'नीली ट्रॉली पर तैयार माल की तस्वीर लें', bn: 'নীল ট্রলিতে প্রস্তুত পণ্যের ছবি তুলুন' },
    { en: 'Verify Box Count (Default 10 boxes, quick adjust)', 'zh-CN': '核对箱数 (默认 10 箱，可一键微调)', 'zh-TW': '核對箱數 (默認 10 箱，可一鍵微調)', ms: 'Sahkan Bilangan Kotak (Lalai 10 kotak, pelarasan pantas)', my: 'သေတ္တာအရေအတွက် စစ်ဆေးပါ (ပုံမှန် ၁၀ သေတ္တာ၊ အမြန်ချိန်ညှိနိုင်)', hi: 'डिब्बों की संख्या सत्यापित करें (डिफ़ॉल्ट 10 डिब्बे, त्वरित समायोजन)', bn: 'বাক্স সংখ্যা যাচাই করুন (ডিফল্ট ১০ বাক্স, দ্রুত সমন্বয়)' },
    { en: 'Confirm Intake', 'zh-CN': '确认入库', 'zh-TW': '確認入庫', ms: 'Sahkan Kemasukan', my: 'အတည်ပြု လက်ခံပါ', hi: 'प्रवेश की पुष्टि करें', bn: 'ইনটেক নিশ্চিত করুন' },
    { en: 'Today Trolley Output Logs', 'zh-CN': '今日推车报工记录', 'zh-TW': '今日推車報工記錄', ms: 'Rekod Keluaran Troli Hari Ini', my: 'ယနေ့ ထော်လာဂျီ ထုတ်လုပ်မှုမှတ်တမ်း', hi: 'आज का ट्रॉली उत्पादन रिकॉर्ड', bn: 'আজকের ট্রলি আউটপুট রেকর্ড' },
    { en: 'Real-time piece-rate sync per trolley to ledger', 'zh-CN': '按推车计件实时同步至 production_logs_v2', 'zh-TW': '按推車計件實時同步至 production_logs_v2', ms: 'Segerak ikut troli ke lejar secara masa nyata', my: 'ထော်လာဂျီအလိုက် အချိန်နှင့်တစ်ပြေးညီ စာရင်းသို့ ချိန်ညှိပါ', hi: 'ट्रॉली द्वारा लेज़र में रीयल-टाइम सिंक', bn: 'ট্রলি অনুযায়ী লেজারে রিয়েল-টাইম সিঙ্ক' },
    { en: "Today's Cartons", 'zh-CN': '今日累计出箱', 'zh-TW': '今日累計出箱', ms: 'Jumlah Kotak Hari Ini', my: 'ယနေ့ စုစုပေါင်း သေတ္တာများ', hi: 'आज के कुल डिब्बे', bn: 'আজকের মোট বাক্স' },
    { en: "Today's Total Rolls", 'zh-CN': '今日累计卷数', 'zh-TW': '今日累計卷數', ms: 'Jumlah Gulung Hari Ini', my: 'ယနေ့ စုစုပေါင်း လိပ်များ', hi: 'आज के कुल रोल', bn: 'আজকের মোট রোল' },
    { en: 'Total Weight (Net)', 'zh-CN': '预估总产重', 'zh-TW': '預估總產重', ms: 'Anggaran Berat Bersih', my: 'ခန့်မှန်းခြေ စုစုပေါင်း အလေးချိန်', hi: 'अनुमानित कुल वजन', bn: 'আনুমানিক মোট ওজন' },
    { en: 'Downtime Reason Log', 'zh-CN': '停机归因登记', 'zh-TW': '停機歸因登記', ms: 'Daftar Sebab Henti Mesin', my: 'စက်ရပ်ရခြင်း အကြောင်းရင်း မှတ်တမ်း', hi: 'डाउनटाइम कारण रिकॉर्ड', bn: 'ডাউনটাইম কারণ রেকর্ড' },
    { en: 'Log Downtime / Screen Change', 'zh-CN': '登记停机 / 换网', 'zh-TW': '登記停機 / 換網', ms: 'Daftar Henti / Tukar Penapis', my: 'စက်ရပ် / ပိုက်ကွန်လဲခြင်း မှတ်တမ်းတင်ပါ', hi: 'डाउनटाइम / स्क्रीन चेंज दर्ज करें', bn: 'ডাউনটাইম / স্ক্রিন পরিবর্তন রেকর্ড করুন' },
    { en: 'Machine Inspection & Recipe Log', 'zh-CN': '机台巡检与配料快记', 'zh-TW': '機台巡檢與配料快記', ms: 'Pemeriksaan Mesin & Resipi Pantas', my: 'စက်စစ်ဆေးခြင်းနှင့် ဖော်မြူလာမှတ်တမ်း', hi: 'मशीन निरीक्षण और त्वरित फॉर्मूला', bn: 'মেশিন পরিদর্শন ও দ্রুত ফর্মুলা' },
    { en: 'Shift Handover & Clock Out', 'zh-CN': '交班登出', 'zh-TW': '交班登出', ms: 'Serah Syif & Log Keluar', my: 'ဂျူတီလွှဲပြောင်းပြီး ထွက်ပါ', hi: 'हैंडओवर और क्लॉक आउट', bn: 'শিফ্ট হস্তান্তর ও ক্লক আউট' },
    { en: 'Scan Switch Machine', 'zh-CN': '扫码换机', 'zh-TW': '掃碼換機', ms: 'Imbas Tukar Mesin', my: 'စက်ပြောင်းရန် စကင်န်ဖတ်ပါ', hi: 'मशीन बदलने के लिए स्कैन करें', bn: 'মেশিন পরিবর্তন করতে স্ক্যান করুন' },
    { en: 'Current Machine', 'zh-CN': '当前机台', 'zh-TW': '當前機台', ms: 'Mesin Semasa', my: 'လက်ရှိစက်', hi: 'वर्तमान मशीन', bn: 'বর্তমান মেশিন' },
    { en: "Today's Total", 'zh-CN': '今日累计', 'zh-TW': '今日累計', ms: 'Jumlah Hari Ini', my: 'ယနေ့ စုစုပေါင်း', hi: 'आज का कुल', bn: 'আজকের মোট' },
    { en: 'No operator currently bound to this machine', 'zh-CN': '该机台暂未绑定值班操作员', 'zh-TW': '該機台暫未綁定值班操作員', ms: 'Tiada operator terikat pada mesin ini', my: 'ဤစက်တွင် အော်ပရေတာ မသတ်မှတ်ရသေးပါ', hi: 'इस मशीन से कोई ऑपरेटर नहीं जुड़ा है', bn: 'এই মেশিনের সাথে কোনো অপারেটর যুক্ত নেই' },
    { en: 'Please bind operator first to enable production recording', 'zh-CN': '请先绑定操作员以开启生产记录', 'zh-TW': '請先綁定操作員以開啟生產記錄', ms: 'Sila ikat operator terlebih dahulu untuk membolehkan rekod pengeluaran', my: 'ထုတ်လုပ်မှုမှတ်တမ်း စတင်ရန် အော်ပရေတာကို ဦးစွာချိတ်ဆက်ပါ', hi: 'उत्पादन रिकॉर्डिंग सक्षम करने के लिए पहले ऑपरेटर को बाइंड करें', bn: 'উৎপাদন রেকর্ডিং সক্ষম করতে প্রথমে অপারেটর লিঙ্ক করুন' },
    { en: 'Bind Operator', 'zh-CN': '绑定操作员', 'zh-TW': '綁定操作員', ms: 'Ikat Operator', my: 'အော်ပရေတာ ချိတ်ဆက်ပါ', hi: 'ऑपरेटर जोड़ें', bn: 'অপারেটর লিঙ্ক করুন' },
    { en: 'Scan Badge to Clock In', 'zh-CN': '扫码上机打卡', 'zh-TW': '掃碼上機打卡', ms: 'Imbas Kad Masuk Syif', my: 'စတင်ရန် တံဆိပ်စကင်န်ဖတ်ပါ', hi: 'क्लॉक इन के लिए बैज स्कैन करें', bn: 'ক্লক ইন করতে ব্যাজ স্ক্যান করুন' },
    { en: 'Defect & Scale', 'zh-CN': '次品过磅', 'zh-TW': '次品過磅', ms: 'Timbang Barang Cacat', my: 'ချို့ယွင်းချက်နှင့် အလေးချိန်', hi: 'दोषपूर्ण और स्केल', bn: 'ত্রুটিযুক্ত ও ওজন' },
    { en: 'Resin & Recipe', 'zh-CN': '原料配料', 'zh-TW': '原料配料', ms: 'Resipi & Bahan Mentah', my: 'ကုန်ကြမ်းနှင့် ဖော်မြူလာ', hi: 'राल और फॉर्मूला', bn: 'রজন ও ফর্মুলা' },
    { en: 'AI Vision Recognition', 'zh-CN': 'AI 视觉识别', 'zh-TW': 'AI 視覺識別', ms: 'Pengecaman Penglihatan AI', my: 'AI အမြင်ဖြင့် ခွဲခြားခြင်း', hi: 'एआई विज़न पहचान', bn: 'এআই ভিশন রিকগনিশন' },
    { en: 'Manual adjust available', 'zh-CN': '可手动微调', 'zh-TW': '可手動微調', ms: 'Boleh dilaras manual', my: 'လက်ဖြင့် ချိန်ညှိနိုင်သည်', hi: 'मैनुअल समायोजन उपलब्ध', bn: 'ম্যানুয়াল সমন্বয় উপলব্ধ' },
    { en: 'Confirm Trolley & Print Label', 'zh-CN': '确认本车入库并打印标贴', 'zh-TW': '確認本車入庫並打印標貼', ms: 'Sahkan Troli & Cetak Label', my: 'ထော်လာဂျီ အတည်ပြုပြီး လေဘယ်ထုတ်ပါ', hi: 'ट्रॉली की पुष्टि करें और लेबल प्रिंट करें', bn: 'ট্রলি নিশ্চিত করুন এবং লেবেল প্রিন্ট করুন' },
    { en: 'Submit Defect Record', 'zh-CN': '确认提交次品记录', 'zh-TW': '確認提交次品記錄', ms: 'Hantar Rekod Cacat', my: 'ချို့ယွင်းချက် မှတ်တမ်းတင်ပါ', hi: 'दोष रिकॉर्ड सबमिट करें', bn: 'ত্রুটি রেকর্ড জমা দিন' },
    { en: 'Submit QC Inspection Proof', 'zh-CN': '提交 QC 质检存证', 'zh-TW': '提交 QC 質檢存證', ms: 'Hantar Bukti Pemeriksaan QC', my: 'QC သက်သေ တင်သွင်းပါ', hi: 'QC निरीक्षण प्रमाण सबमिट करें', bn: 'QC পরিদর্শন প্রমাণ জমা দিন' },
    { en: 'Submit Resin Batch Proof', 'zh-CN': '提交原料投料存证', 'zh-TW': '提交原料投料存證', ms: 'Hantar Bukti Bahan Mentah', my: 'ကုန်ကြမ်းအထောက်အထား တင်သွင်းပါ', hi: 'कच्चा माल बैच प्रमाण सबमिट करें', bn: 'কাঁচামাল ব্যাচ প্রমাণ জমা দিন' },
    { en: 'Taiping Main (T1-T5)', 'zh-CN': '太平总厂 (T1-T5)', 'zh-TW': '太平總廠 (T1-T5)', ms: 'Kilang Taiping (T1-T5)', my: 'တာပင်းပင်မစက်ရုံ (T1-T5)', hi: 'ताइपिंग मेन (T1-T5)', bn: 'তাইপিং মেইন (T1-T5)' },
    { en: 'Nilai Hub (N1-N3)', 'zh-CN': '汝来厂 (N1-N3)', 'zh-TW': '汝來廠 (N1-N3)', ms: 'Kilang Nilai (N1-N3)', my: 'နီလိုင်စက်ရုံ (N1-N3)', hi: 'निलाई हब (N1-N3)', bn: 'নিলাই হাব (N1-N3)' },
    { en: 'Kelantan (K1)', 'zh-CN': '吉兰丹厂 (K1)', 'zh-TW': '吉蘭丹廠 (K1)', ms: 'Kilang Kelantan (K1)', my: 'ကလန်တန်စက်ရုံ (K1)', hi: 'केलांटन (K1)', bn: 'কেলান্তান (K1)' },
    { en: 'Johor Hub (J1)', 'zh-CN': '柔佛厂 (J1)', 'zh-TW': '柔佛廠 (J1)', ms: 'Kilang Johor (J1)', my: 'ဂျိုဟိုးစက်ရုံ (J1)', hi: 'जोहोर हब (J1)', bn: 'জোহর হাব (J1)' },
    { en: 'All Plants', 'zh-CN': '全部厂区', 'zh-TW': '全部廠區', ms: 'Semua Kilang', my: 'စက်ရုံအားလုံး', hi: 'सभी कारखाने', bn: 'সব কারখানা' },
    { en: 'This Machine', 'zh-CN': '本机留痕', 'zh-TW': '本機留痕', ms: 'Mesin Ini', my: 'ဤစက်မှတ်တမ်း', hi: 'यह मशीन', bn: 'এই মেশিন' },
    { en: 'All Activity', 'zh-CN': '全厂动态', 'zh-TW': '全廠動態', ms: 'Aktiviti Seluruh Kilang', my: 'စက်ရုံတစ်ခုလုံး လှုပ်ရှားမှု', hi: 'सभी गतिविधियाँ', bn: 'সব কার্যক্রম' },
    { en: 'Boxes', 'zh-CN': '箱', 'zh-TW': '箱', ms: 'Kotak', my: 'သေတ္တာ', hi: 'डिब्बे', bn: 'বাক্স' },
    { en: 'Rolls', 'zh-CN': '卷', 'zh-TW': '卷', ms: 'Gulung', my: 'လိပ်', hi: 'रोल', bn: 'রোল' }
];
