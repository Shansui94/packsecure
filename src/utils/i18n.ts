...
const zhCNDict: Record<string, string> = {
    ...
    // Audit Report
    '盘点分析与核销': '盘点分析与核销',
    '历史库存盘点调整、差异分析与管理审核日志': '历史库存盘点调整、差异分析与管理审核日志',
    '总盘点次数': '总盘点次数',
    '已核对 SKU 数': '已核对 SKU 数',
    '总净差异': '总净差异',
    '待审核数': '待审核数',
    '搜索数据库': '搜索数据库',
    '单号、库位、SKU、盘点员...': '单号、库位、SKU、盘点员...',
    '库位筛选': '库位筛选',
    '所有库位': '所有库位',
    '起始日期': '起始日期',
    '截止日期': '截止日期',
    '查询': '查询',
    '每日分析与准确率': '每日分析与准确率',
    '盘盈、盘亏与完全匹配率多维透视': '盘盈、盘亏与完全匹配率多维透视',
    '新注册待审批': '新注册待审批',
    '生产报告与分析': '生产报告与分析',
    '物流出车报告': '物流出车报告',
    '生产报告': '生产报告',
    '物流报告': '物流报告',
    '选择螺杆通道配置混料配方及巡检': '选择螺杆通道配置混料配方及巡检',
    '选择目标螺杆通道': '选择目标螺杆通道',
    '配料与Mix料': '配料与Mix料',
    '位置调整': '位置调整',
    '温度照片': '温度照片',
...
const enDict: Record<string, string> = {
    ...
    // Audit Report
    '盘点分析与核销': 'Audit Analytics & Verification',
    '历史库存盘点调整、差异分析与管理审核日志': 'Historical stock adjustments, variance analysis, and managerial review log.',
    '总盘点次数': 'Total Audits',
    '已核对 SKU 数': 'SKUs Checked',
    '总净差异': 'Total Net Variance',
    '待审核数': 'Pending Reviews',
    '搜索数据库': 'Search Database',
    '单号、库位、SKU、盘点员...': 'Ref, Location, SKU, Auditor...',
    '库位筛选': 'Location Filter',
    '所有库位': 'All Locations',
    '起始日期': 'Date From',
    '截止日期': 'Date To',
    '查询': 'Fetch',
    '每日分析与准确率': 'Daily Analytics & Accuracy',
    '盘盈、盘亏与完全匹配率多维透视': 'Multi-dimensional view of Surpluses, Deficits, and Perfect Match Ratio.',
    '新注册待审批': 'Pending Registrations',
    '生产报告与分析': 'Production Analytics',
    '物流出车报告': 'Logistics Reports',
    '生产报告': 'Production Reports',
    '物流报告': 'Logistics Reports',
    '选择螺杆通道配置混料配方及巡检': 'Select screw channel to configure recipe & inspection',
    '选择目标螺杆通道': 'Select Screw Channel',
    '配料与Mix料': 'Raw Materials & Mix',
    '位置调整': 'Position Adjustment',
    '温度照片': 'Temperature Photos',
    '本机日志': 'Machine Logs',
...
const myDict: Record<string, string> = {
    ...
    'Audit Report': 'စာရင်းစစ်အစီရင်ခံစာ',
    '盘点报告': 'စာရင်းစစ်အစီရင်ခံစာ',
    '盘点分析与核销': 'စာရင်းစစ်ဆန်းစစ်ချက်',
    '总盘点次数': 'စုစုပေါင်း စာရင်းစစ်ချက်',
    '已核对 SKU 数': 'စစ်ဆေးပြီး SKU များ',
    '总净差异': 'စုစုပေါင်း ခြားနားချက်',
    '待审核数': 'စစ်ဆေးရန် ကျန်ရှိသည်',
    '搜索数据库': 'ဒေတာဘေ့စ် ရှာဖွေရန်',
    '库位筛选': 'တည်နေရာ စစ်ထုတ်မှု',
    '所有库位': 'တည်နေရာအားလုံး',
    '起始日期': 'စတင်သည့်ရက်စွဲ',
    '截止日期': 'ပြီးဆုံးသည့်ရက်စွဲ',
    '查询': 'ရယူရန်',
